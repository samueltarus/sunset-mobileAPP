...
class LanguageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            'message'=>'Language has been inserted successfully'
        ],200);
    }
    ...
    public function update(Request $request)
    {
        ...
        if (
            ...
            flash(localize('This code is already used for another language'))->error();
            return response()->json([
               'message'=>'This code is already used for another language'
            ],200);
        }
        ...
        return response()->json([
            'message'=>'TLanguage has been updated successfully'
        ],200);
    }
    ...
    public function key_value_store(Request $request)
    {
        ...
        foreach ($request->values as $key => $value) {
            ...
            if ($localization == null) {
                ...
                $localization->t_value = $value ? $value : $key;
                $localization->save();
            } else {
                $localization->t_value = $value ? $value : $key;;
                $localization->save();
        ...
        return response()->json([
            'message'=>'Localizations have been updated',
        ]);
    }
}
